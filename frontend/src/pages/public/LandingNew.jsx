...
import { GraduationCap, Users, BarChart, Shield, Bot, Lock } from 'lucide-react';
      ...
      <Section background="slate">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card hover>
            <div className="p-6 text-center">
              <div className="mx-auto w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                <Bot size={32} className="text-[#1f3c88]" />
              </div>
          ...
          <Card hover>
            <div className="p-6 text-center">
              <div className="mx-auto w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                <Lock size={32} className="text-[#1f3c88]" />
              </div>
          ...
          <Card hover>
            <div className="p-6 text-center">
              <div className="mx-auto w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                <BarChart size={32} className="text-[#1f3c88]" />
              </div>
          ...
          <Card hover>
            <div className="p-6 text-center">
              <div className="mx-auto w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                <Users size={32} className="text-[#1f3c88]" />
              </div>
      ...
      <Section background="white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            <div className="p-8">
              <div className="w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                <GraduationCap size={40} className="text-[#1f3c88]" />
              </div>
          ...
          <Card>
            <div className="p-8">
              <div className="w-16 h-16 rounded-lg flex items-center justify-center mb-4">
                <Users size={40} className="text-[#1f3c88]" />
              </div>
